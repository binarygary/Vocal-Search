<?php
/**
 * Vocal_Search Test Bootstrapper.
 *
 * @since   0.1.0
 ...
 * @since 0.1.0
 */
function _manually_load_vocal_search_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/vocal-search.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_vocal_search_plugin' );
